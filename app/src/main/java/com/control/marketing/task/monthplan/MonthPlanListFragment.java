...
public class MonthPlanListFragment extends BaseFragment {
    ...
    private MonthPlanListAdapter monthPlanListAdapter;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == -1 && requestCode == AddTaskActivity.REQUEST_CODE) {
            ...
            monthPlanListAdapter.refreshData(taskBeanList);
        }
    }
    ...
    private void initView(View view) {
        ...
        monthPlanListAdapter = new MonthPlanListAdapter(context);
        listView.setAdapter(monthPlanListAdapter);
    }
